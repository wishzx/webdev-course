...
class Example extends React.Component {
  ...
  handleChangeMotto() {
    var answer = prompt('What is your motto?', this.state.motto);
    this.setState({ motto: answer });
  }
    ...
    return (
      <div className="container Example">
        ...
        <div className="cs142-motto-update">
          <p onClick={(e) => this.handleChangeMotto(e)}>{this.state.name + " " + this.state.motto}</p>
        </div>
